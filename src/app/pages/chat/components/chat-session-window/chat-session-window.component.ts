...
@Component({
  selector: 'app-chat-session-window',
  templateUrl: './chat-session-window.component.html',
  styleUrls: ['./chat-session-window.component.scss']
})
export class ChatSessionWindowComponent implements OnInit {
